  ...
  return (
    <div className="space-y-3">
      ...
      <div
        ...
        style={{ height: 230, userSelect: 'none', WebkitUserSelect: 'none' as const, cursor: 'grab' }}
      ...
      >
        {chapters.map((chapter, i) => {
          ...
          const dScale   = isActive ? 1 : abs === 1 ? 0.86 : 0.74
          const dOpacity = isActive ? 1 : abs === 1 ? 0.45 : abs === 2 ? 0.18 : 0
          ...
          return (
            ...
            >
              <div className="mb-4 flex items-start justify-between gap-3">
                ...
                <span className="rounded-md px-2 py-1 text-[10px] font-bold uppercase tracking-[0.24em] text-[#030508]" style={{ backgroundColor: accent }}>
                  {progress}%
                </span>
              </div>
              ...
              <div className="space-y-3">
                <div>
                  <div className="mb-1.5 flex items-center justify-between text-[10px] uppercase tracking-[0.28em] text-[var(--text-muted)]">
                    <span>Questions</span><span>{done}/{total || 0}</span>
                  </div>
                ...
                <div>
                  ...
                  <div className="progress-track">
                    <div className="progress-fill" style={{ width: `${notes}%`, backgroundColor: accent, opacity: 0.75 }} />
                  </div>
                </div>
